//babel badApples.js | node

console.log("badApples.js")
...
// 1.A bad package should have the bad apple replaced if there is another bad package 
// with a good apple to spare. Else, the bad package should be discarded.
